...
public class VendorSeeders implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void createCategories() {
        ...
        String[] descriptions = {
                "Deliciosa comida", "Entretenimiento divertido", "Decoración hermosa", "Seguridad confiable",
                "Transporte eficiente",
                "Fotografía profesional", "Música en vivo", "Iluminación espectacular", "Sonido de calidad",
                "Flores frescas",
                "Bebidas variadas", "Animación para todos", "Juegos interactivos", "Vestuario elegante",
                "Invitaciones creativas",
                "Recuerdos únicos", "Pasteles deliciosos", "Catering completo", "Limpieza impecable",
                "Logística precisa",
                "Alquiler de equipos", "Planificación detallada", "Coordinación perfecta", "Publicidad efectiva",
                "Marketing estratégico",
                "Diseño gráfico", "Gestión de redes sociales", "Producción de video", "Streaming en vivo",
    ...
    private void createVendors() {
        ...
        String[] locations = {
                "San José, San José", "San José, Escazú", "San José, Desamparados", "San José, Puriscal",
                "San José, Tarrazú",
                "Alajuela, Alajuela", "Alajuela, San Ramón", "Alajuela, Grecia", "Alajuela, San Mateo",
                "Alajuela, Atenas",
                "Cartago, Cartago", "Cartago, Paraíso", "Cartago, La Unión", "Cartago, Jiménez", "Cartago, Turrialba",
                "Heredia, Heredia", "Heredia, Barva", "Heredia, Santo Domingo", "Heredia, Santa Bárbara",
                "Heredia, San Rafael",
                "Guanacaste, Liberia", "Guanacaste, Nicoya", "Guanacaste, Santa Cruz", "Guanacaste, Bagaces",
                "Guanacaste, Carrillo",
                "Puntarenas, Puntarenas", "Puntarenas, Esparza", "Puntarenas, Buenos Aires",
                "Puntarenas, Montes de Oro", "Puntarenas, Osa",
    ...
    private void createVendorServices(Vendor vendor, String categoryName) {
        ...
        for (int i = 1; i <= 3; i++) {
            ...
            vendorService.setPrice(50.0 + (3000.0 - 50.0) * random.nextDouble()); // Precio aleatorio entre 50.0 y
                                                                                  // 3000.0
